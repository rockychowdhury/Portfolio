      ...
      <div className="flex flex-col gap-12 lg:flex-row lg:items-center">
          ...
          <div className="flex-1 lg:max-w-xl relative group">
            ...
            >
              ...
              <div 
                className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat pointer-events-none opacity-[0.6] dark:opacity-[0.6] mix-blend-multiply dark:mix-blend-screen"
                style={{ backgroundImage: "var(--texture-url, url(/assets/papers/whitetexture.webp))" }}
              />
