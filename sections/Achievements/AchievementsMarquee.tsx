...
import { OrbitPattern } from "@/components/ui/BackgroundPatterns";

type Props = { achievements: IAchievement[] };

const ROW_ONE_CATEGORIES: IAchievement["category"][] = [
  "education",
  "certification",
  "project",
];

const ROW_TWO_CATEGORIES: IAchievement["category"][] = [
...
export function AchievementsMarquee({ achievements }: Props) {
  ...
  return (
    <SectionWrapper id="achievements" className="relative w-full pt-12 sm:pt-16 pb-16 sm:pb-24 overflow-hidden bg-background">
      <OrbitPattern />
