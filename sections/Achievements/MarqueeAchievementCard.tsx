...
import { CATEGORY_META } from "./achievementsData";

type Props = { achievement: IAchievement };

export function MarqueeAchievementCard({ achievement }: Props) {
  const meta = CATEGORY_META[achievement.category as keyof typeof CATEGORY_META];
