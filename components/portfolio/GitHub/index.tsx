...
export default function GitHubSection() {
  ...
  return (
    <SectionWrapper id="github" className="relative min-h-screen w-full overflow-hidden bg-background py-24 px-6 md:px-12 lg:px-20">
      ...
      <div className="relative mx-auto max-w-[1400px]">
        ...
        <div className="absolute top-0 -left-12 hidden flex-col items-center gap-8 lg:flex">
          ...
          <div className="h-24 w-px border-l border-dashed border-border/30" />
        </div>
