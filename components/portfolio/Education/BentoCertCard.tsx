  ...
  const getTheme = () => {
    if (isEducation) {
      return {
        ...
        bgCard: "bg-[url('/assets/papers/darktexture.jpg')] bg-cover bg-center",
    ...
    <>
      ...
      >
        ...
        `}>
          ...
          {!isEducation && (
            <div 
              className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat pointer-events-none opacity-[0.5] dark:opacity-[0.6] mix-blend-multiply dark:mix-blend-screen bg-[url('/assets/papers/whitetexture.jpg')] dark:bg-[url('/assets/papers/darktexture.jpg')]" 
            />
          )}
          ...
          <div className="relative z-10 p-4 flex flex-col flex-1">
            ...
            >
              <img
                ...
                className={`w-full h-full transition-transform duration-700 group-hover/media:scale-105 ${isEducation ? "object-contain drop-shadow-md" : "object-cover"}`}
              />
            ...
            <div className="mb-3 flex-1 flex flex-col">
              ...
              <div className="flex items-center gap-2 mb-3">
                <div className={`w-6 h-6 rounded flex items-center justify-center border overflow-hidden p-0.5 ${isEducation ? "bg-white/10 border-white/10" : "bg-white dark:bg-zinc-800 border-border"}`}>
                    <img 
                      src={item.ins_logo} 
                      alt={item.ins_name} 
