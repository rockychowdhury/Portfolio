...
const projects = [
  {
    ...
    videoUrl: "/assets/projectpreview/petcarepreview.webm",
    isFeatured: true,
    order: 1,
  },
  {
    ...
    videoUrl: "/assets/projectpreview/employeepreview.webm",
    isFeatured: true,
    order: 2,
  },
  {
    ...
    longDescription: "NeuroFlux is a state-of-the-art dashboard designed for researchers to monitor and optimize large-scale neural networks in real-time. This preview showcases the neural flow mapping module.",
    ...
    videoUrl: "/assets/projectpreview/petcarepreview.webm", // Reusing this for demo
    isFeatured: true,
    order: 3,
  },
  {
